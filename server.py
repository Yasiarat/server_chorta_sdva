...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'sturthdgjhdgjdtyyktdgh'

users = [
    {'username': 'Василий', 'password': '12345'},
    {'username': 'Джимм', 'password': '12345'},
    {'username': 'Даша', 'password': '12345'},
    {'username': 'Вика', 'password': '12345'}
]
...
@app.route('/index')
def index():
    return render_template('index.html', username='yasia_rat')
